// These import traits from the Borsh crate, which is used for binary serialization in Solana programs.
use borsh::{BorshDeserialize, BorshSerialize};
use borsh_derive::{BorshDeserialize, BorshSerialize};
// Imports various modules from the Solana Program library, including account information, entrypoints, program results, messages, and public key types.
use solana_program::{
...
// Import statement that brings the CounterInstructions type into the current module/scope
use crate::instructions::{CounterInstructions, UpdateArgs};

pub mod instructions; // Declares a module named instructions.

// This is a derive attribute for the CounterAccount struct.
#[derive(Debug, BorshDeserialize, BorshSerialize)]
// Intended to represent the state of a counter on the Solana blockchain.
...
pub fn process_instruction(
    _program_id: &Pubkey,     // smart contract address
...
// cargo test -> compiles tests
// cargo test -- --nocapture -> to see print lines